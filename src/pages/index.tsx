  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Trainer - Your Gateway to Comprehensive Learning. From course creation to unique URL generation, content creation, quizzes, programming exercises, and practical use cases, we ensure a logical and progressive learning experience."
        />
      </Head>
        ...
        <Flex p={8} flex={1} align={'center'} justify={'center'}>
          <Stack position="relative" spacing={6} w={'full'} maxW={'lg'}>
            ...
            <Text fontSize={{ base: 'md', lg: 'lg' }} color={'gray.500'}>
              {`Welcome to Trainer - Your Gateway to Comprehensive Learning. From course creation to unique URL generation, content creation, quizzes, programming exercises, and practical use cases, we ensure a logical and progressive learning experience.`}
            </Text>
